...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(e,t){e.exports=function(e,t,i,n){const s=e=>e&&"object"==typeof e&&"default"in e?e:{default:e},o=s(t),r=s(i),a="toast",l=".bs.toast",c=`mouseover${l}`,u=`mouseout${l}`,d=`focusin${l}`,f=`focusout${l}`,h=`hide${l}`,p=`hidden${l}`,g=`show${l}`,m=`shown${l}`,_="fade",b="hide",v="show",y="showing",w={animation:"boolean",autohide:"boolean",delay:"number"},x={animation:!0,autohide:!0,delay:5e3};class E extends r.default{constructor(e,t){super(e,t),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return x}static get DefaultType(){return w}static get NAME(){return a}show(){if(o.default.trigger(this._element,g).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(_);const t=()=>{this._element.classList.remove(y),o.default.trigger(this._element,m),this._maybeScheduleHide()};this._element.classList.remove(b),e.reflow(this._element),this._element.classList.add(v,y),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(o.default.trigger(this._element,h).defaultPrevented)return;const e=()=>{this._element.classList.add(b),this._element.classList.remove(y,v),o.default.trigger(this._element,p)};this._element.classList.add(y),this._queueCallback(e,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(v),super.dispose()}isShown(){return this._element.classList.contains(v)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(e,t){switch(e.type){case"mouseover":case"mouseout":this._hasMouseInteraction=t;break;case"focusin":case"focusout":this._hasKeyboardInteraction=t}if(t)return void this._clearTimeout();const i=e.relatedTarget;this._element===i||this._element.contains(i)||this._maybeScheduleHide()}_setListeners(){o.default.on(this._element,c,(e=>this._onInteraction(e,!0))),o.default.on(this._element,u,(e=>this._onInteraction(e,!1))),o.default.on(this._element,d,(e=>this._onInteraction(e,!0))),o.default.on(this._element,f,(e=>this._onInteraction(e,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(e){return this.each((function(){const t=E.getOrCreateInstance(this,e);if("string"==typeof e){if(void 0===t[e])throw new TypeError(`No method named "${e}"`);t[e](this)}}))}}return n.enableDismissTrigger(E),e.defineJQueryPlugin(E),E}(r(),c(),w(),A())}(Qt);var Kt,Xt,Yt,Ut=Qt.exports;Kt=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,Xt=navigator.userAgent.toLowerCase().indexOf("opera")>-1,Yt=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(Kt||Xt||Yt)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var e,t=location.hash.substring(1);/^[A-z0-9_-]+$/.test(t)&&(e=document.getElementById(t))&&(/^(?:a|select|input|button|textarea)$/i.test(e.tagName)||(e.tabIndex=-1),e.focus())}),!1),jQuery(document).ready((function(e){e((function(){e('[data-bs-toggle="tooltip"]').tooltip().click((function(e){e.preventDefault()}))}));var t=e("body");jQuery(window).scroll((function(i){e(this).scrollTop()>=30?t.addClass("scrolled"):t.removeClass("scrolled")})),e("#navbarNavOffcanvas").on("show.bs.offcanvas",(function(){t.addClass("menu-open")})),e("#navbarNavOffcanvas").on("hidden.bs.offcanvas",(function(){t.removeClass("menu-open")})),e("#search-collapse").on("shown.bs.collapse",(function(){t.addClass("search-open"),e("#search-collapse .search-field").focus()})),e("#search-collapse").on("hidden.bs.collapse",(function(){t.removeClass("search-open")})),e(".sub-menu-toggler").click((function(t){t.preventDefault(),e(this).parent().next().toggleClass("show"),e(this).parent().parent().toggleClass("show")})),e(".dropdown, .dropup").hover((function(){e(".dropdown-toggle",this).dropdown("toggle").blur()})),e(".dropdown-menu").click((function(e){e.stopPropagation()})),e("#footer-ticker").length&&e("#footer-ticker").eocjsNewsticker({speed:15,divider:" - ",timeout:0}),e(".valores-nutricionales").each((function(){e(".progress-bar").each((function(t){var i=e(this).attr("aria-valuenow")/e(this).attr("aria-valuemax")*100;e(this).css("width",i+"%")}))})),e(".slick-carousel").each((function(){var t=e(this);t.on("init",(function(e,i){i.slideCount<=i.options.slidesToShow&&t.find(".slick-arrow").show()})),e(this).slick({dots:!0,arrows:!0,infinite:!1,speed:300,slidesToShow:1,slidesToScroll:1,autoplay:!1,centerMode:!0,centerPadding:"25%",appendArrows:e(this).parent().find(".slick-navigation-container"),appendDots:e(this).parent().find(".slick-navigation-container"),responsive:[{breakpoint:1320,settings:{slidesToShow:1,slidesToScroll:1,centerMode:!1}}]})})),e(".slick-gallery-slider").each((function(){var t=e(this);t.on("init",(function(e,i){i.slideCount<=i.options.slidesToShow&&t.find(".slick-arrow").show()})),e(this).slick({dots:!0,arrows:!0,infinite:!1,speed:300,slidesToShow:1,slidesToScroll:1,autoplay:!1,appendArrows:e(this).parent().find(".slick-navigation-container"),appendDots:e(this).parent().find(".slick-navigation-container")})})),e(".slick-invisible-prev").on("click",(function(){e(this).parent().find(".slick-carousel").slick("slickPrev")})),e(".slick-invisible-next").on("click",(function(){e(this).parent().find(".slick-carousel").slick("slickNext")})),e(".slick-carousel").on("edge",(function(t,i,n){e(this).parent().find(".slick-invisible-prev").toggleClass("invisible","left"===n),e(this).parent().find(".slick-invisible-next").toggleClass("invisible","right"===n)})),e(window).on("resize orientationChange",(function(t){e(".slick-slider").slick("resize")}))})),e.Alert=T,e.Button=k,e.Carousel=I,e.Collapse=M,e.Dropdown=vt,e.Modal=Lt,e.Offcanvas=jt,e.Popover=zt,e.Scrollspy=Bt,e.Tab=Vt,e.Toast=Ut,e.Tooltip=Rt}));
